# Simple SQL Setup - Create New Query

Since your SQL editor already has some code, let's create a fresh query:

## Step 1: Create New Query

1. In the SQL Editor, look for a **"+"** button (usually at the top left of the query list, or next to "New query")
2. Click the **"+"** button to create a new blank query
3. You should now see a blank editor
...
1. **Paste** the SQL into the new blank query
2. **Click the green "Run" button** (bottom right)
3. Wait a few seconds

## Step 4: Check Success

You should see "Success" message. Then verify tables:

1. Go to: https://supabase.com/dashboard/project/jbumdbqfglovurosqgjx/editor
2. Check left sidebar for these 4 tables:
   - ✅ `profiles`
   - ✅ `quizzes`
   - ✅ `questions`
   - ✅ `quiz_attempts`

If all 4 tables exist, you're done! ✅
